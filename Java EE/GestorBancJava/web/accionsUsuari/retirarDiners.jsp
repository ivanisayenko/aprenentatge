<%-- 
    Document   : retirarDiners
    Created on : 26-jun-2018, 12:48:39
    Author     : ivani
--%>
    ...
    <body>
        ...
        <div class="main" style="margin: auto">
            <div id="ingresarDiners">
                ...
                <form action="../RetirarDiners" method="post" name="actualitzarCompte">
                    <input name="quantitat" type="number" placeholder="ingresa cuantitat de retirada">
